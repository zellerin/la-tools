...
#+nil (multiple-value-call #'logistic-get-coefficients
  (read-comma-file2 file))
(multiple-value-call #'logistic-get-coefficients (read-comma-file2 "ex2data1.txt") :sigma -4.5s0)
#+END_SRC

#+RESULTS: ex2data1
| 116.66458 | -1.0006036 | 2.4917057 | -11693.544 |
